...
<body>
	...
	<div class="body">
		<div>
		  ...
		  <div>
		    <p align="center" class="style4">Circular Details </p>
			<form method="post" action="">
			  <table width="683" height="67" border="1" align="center" cellpadding="0" cellspacing="0">
                <tr>
				  
                  <th width="48" height="30" bgcolor="#999966"><span class="style41">Subject</span></th></tr><tr>
                  <th width="79" bgcolor="#999966" class="style41">Circular Details </th>
                  
                </tr>
                <?php
		  $i=0;
		  $qry=mysql_query("select * from circular");
		  ...
		  ?>
                <tr>
                  ...
                  <td align="center"><span class="style39"><?php echo $row['sub']; ?></span></td>
                  
                  <td align="center"><span class="style39"><?php echo $row['cdetail']; ?></span></td>
